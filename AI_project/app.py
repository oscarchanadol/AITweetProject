...
# llm = OpenAI(model_name="text-davinci-003", temperature=0.9, openai_api_key=apikey)
llm = ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0.9, openai_api_key=apikey)
